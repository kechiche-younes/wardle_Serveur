...
/**
 * The `window6Controler` class is the controller for the game window with the length of 6.
 * Authors: KECHADI Farid, KECHICHE Younes, TAKIA Mohamed
 */
public class window6Controler {
    ...
    private TextField text1, text11, text111, text112, text12, text121, text122, text13, text131, text132,
            text14, text141, text142, text15, text151, text152, text16, text161, text162,
             text18, text19, text2, text21, text22, text3, text31, text32, text4, text41, text42,
            text5, text51, text52, text6, text61, text62,mots ,hh ,mm,ss;
    @FXML
    ...
    private void initialize() {
        ...
        // Initialiser le tableau de TextField à deux dimensions
        textFields = new TextField[][] {
            {text1, text2, text3, text4, text5, text6},
            {text11, text12, text13, text14, text15, text16 },
            {text18, text21, text31, text41, text51, text61},
            {text111, text121, text131, text141, text151, text161},
            {text19, text22, text32, text42, text52, text62},
            {text112, text122, text132, text142, text152, text162}};
            ...
            System.out.println("le incrémentation + " + incrimentX +" "+ incrimentY);
       ...
       String mot = motsListe.get(indice);
       System.out.println(mot);
       // Split the word into letters
       targetWord = mot.toCharArray();
       ...
       if (incrimentX == wordLength) {
           ...
           if (!motExiste) {
               ...
               for (int z = 0; z < wordLength; z++) {
                ...
                System.out.println("-----------------------------------" + greenCounter + " " + wordLength );
               if (greenCounter == wordLength) {
               ...
               System.out.println("scoreee ==== " + score);
                ...
                System.out.println(" nombre de mot " + nombreDeMot);
                if(nombreDeMot < 3){
                    ...
                    incrimentX = 0;
                    incrimentY = 0;
                    for(int i = incrimentX ; i < wordLength ; i ++){
                        for(int j = incrimentY ; j <6 ; j++){
